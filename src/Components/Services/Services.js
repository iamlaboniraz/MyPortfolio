    ...
    return (
        <>
            ...
            <div id="container">
                ...
                <div class="item">
                    <div class="front"> <img id="team1" class="team" src={python} /> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team2" class="team" src={django}/> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team3" class="team" src={react} /> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team4" class="team" src={kivy} /> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team5" class="team" src={node} /> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team6" class="team" src={html} /> </div>
                    <div class="back">
                ...
                <div class="item">
                    <div class="front"> <img id="team6" class="team" src={javaScript} /> </div>
                    <div class="back">
